...
router.get("/shopProducts/:shopId",authMiddleware,roleMiddleware(["superAdmin","admin","vendor","vendorAdmin","user","owner"]),checkPermission("product.list"), getProductsByShop);
