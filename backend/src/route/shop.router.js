...
router.patch("/updateShop/:shopId",authMiddleware,roleMiddleware(["superAdmin","admin","vendor","vendorAdmin"]),checkPermission("shop.update"),upload.array("images",5), updateShop);
router.delete("/deleteShop/:shopId",authMiddleware,roleMiddleware(["superAdmin","admin","vendor","vendorAdmin"]),checkPermission("shop.delete"), deleteShop);
