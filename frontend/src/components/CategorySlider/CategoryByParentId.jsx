...
import { useGetCategoryByParentIdQuery, useGetCategoryQuery } from "../../redux/category.apiSlice";
// Categories data
...
export default function CategoryByParentId({id}) {
    console.log("id",id)
  const {data:categories} = useGetCategoryByParentIdQuery(id);
    ...
    <div className="mx-auto max-w-7xl px-4 py-10">
      ...
      <Slider {...settings}>
        {pairedCategories.map((pair, index) => (
          <div key={index} className="md:px-3 py-4">
